...
tar -cf "rust-v${_rust_ver}-stable-x86_64-ub2404.tar" rust
sleep 2
rm -fr rust
xz -f -z -9 -k -T$(($(nproc) - 1)) "rust-v${_rust_ver}-stable-x86_64-ub2404.tar"
sleep 2
sha256sum -b "rust-v${_rust_ver}-stable-x86_64-ub2404.tar".xz > "rust-v${_rust_ver}-stable-x86_64-ub2404.tar".xz.sha256
rm -f "rust-v${_rust_ver}-stable-x86_64-ub2404.tar"

rm -fr /tmp/_output
mkdir /tmp/_output
mv -v "rust-v${_rust_ver}-stable-x86_64-ub2404.tar".xz* /tmp/_output/
