...
docker exec ub2204 apt install -y -qqq wget bash gcc g++ cmake m4 pkg-config libc6-dev git curl openssl libssl-dev clang llvm
...
docker exec ub2204 /bin/bash /home/ub2204/rust.sh
